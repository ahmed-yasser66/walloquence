...
import HotInfiniteScroll from "./hot-client";
          ...
          <div className="flex flex-col justify-center gap-3 pt-7">
            <p className="flex items-center gap-3 text-3xl font-bold">
              <Flame
                ...
                aria-hidden="true"
              />
              <span className="dark:text-shadow-[1px_2px_4px_black]">Hot</span>
            </p>
...
async function RenderResult() {
  const initialResponse = await api.get.hot();
    ...
    <section>
      <Wrapper>
        <div className="mt-5 pt-5">
          ...
          <HotInfiniteScroll enabled={initialData.length > 0} />
        </div>
      </Wrapper>
    </section>
  );
